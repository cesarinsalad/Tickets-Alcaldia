...
import { Plus, X, Shield, Ticket, Users, FileText, FolderTree, BookOpen, Monitor, Circle, ArrowLeft, Save, Building2, Clock, Key, BarChart, TrendingUp, ClipboardList } from 'lucide-react';
...
const moduleMeta = {
    ...
    metricas:       { label: 'Métricas',       icon: BarChart },
